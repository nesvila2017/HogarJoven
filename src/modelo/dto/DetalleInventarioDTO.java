...
public class DetalleInventarioDTO {
    ...
    public DetalleInventarioDTO(Integer idDetInvent, Integer idInvent, Integer idProd, Timestamp fechaMov, String descripMov, Integer cantItem, Double costoItem, Double costoTotal, Character tipoMovimiento, Integer cantRest) {
