...
public class Sucursal {
    ...
    public Sucursal(Integer idSucursal, String dirProveedor, Integer idMunipio, Integer idDepto, String nomSucursal, Character tipoSucursal, BigInteger numIdentProv) {
