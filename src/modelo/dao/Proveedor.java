...
public class Proveedor {
    ...
    public Proveedor(Integer idProveedor, Integer numIdent, String razonSocial, Integer idTipoEmpresa, Character genero, Integer idActivEco, Integer idClasProv, Integer digitoVer) {
