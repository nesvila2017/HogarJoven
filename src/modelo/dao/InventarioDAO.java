...
public class InventarioDAO {
    ...
    public InventarioDAO(Integer idInventario, Integer idProducto, BigInteger numIdentProv, Integer maxInventario, Integer minInventario, Timestamp fechaRegistro) {
