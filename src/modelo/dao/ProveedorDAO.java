...
public class ProveedorDAO {
    ...
    public ProveedorDAO(Integer idProveedor, Integer numIdent, String razonSocial, Integer idTipoEmpresa, Character genero, Integer idActivEco, Integer idClasProv, Integer digitoVer) {
