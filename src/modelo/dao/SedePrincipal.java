...
public class SedePrincipal {
    ...
    public SedePrincipal(Integer idSedePrincipal, Integer provNumIdent, String dirSede, String telSede, String celular, String email, String web, Integer idMunipio, Integer idDepto) {
