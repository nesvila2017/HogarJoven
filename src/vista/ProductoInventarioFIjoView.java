 ...
 * @author Fucker
 */
public class ProductoInventarioFIjoView extends javax.swing.JFrame {
    ...
    private static ProductoInventarioFIjoView iniciarProductoView;

    private ProductoInventarioFIjoView() {
    ...
    public static ProductoInventarioFIjoView inicializarProducto(){
        if (iniciarProductoView==null) {
            iniciarProductoView = new ProductoInventarioFIjoView();
    ...
    private void initComponents() {
        ...
        txtFechaReg.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        ...
        txtFechaCompra.setBackground(new java.awt.Color(22, 29, 64));
        txtFechaCompra.setFocusable(false);
        txtFechaCompra.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        txtFechaCompra.setMinimumSize(new java.awt.Dimension(50, 24));
        txtFechaCompra.setOpaque(false);
        txtFechaCompra.setPreferredSize(new java.awt.Dimension(132, 24));

        jLabel13.setFont(new java.awt.Font("Segoe UI Semilight", 0, 18)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(204, 204, 204));
        jLabel13.setText("Fecha Adquisición/Factura:*");
                ...
                .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel4Layout.createSequentialGroup()
                        .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                            ...
                            .add(txtFechaReg, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .add(18, 18, 18)
                        .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jLabel13)
                            .add(jLabel3))
                        ...
                        .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel4Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                                .add(jButton5))
                            .add(txtFechaCompra, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .add(13, 13, 13))
        );
            ...
            .add(jPanel4Layout.createSequentialGroup()
                ...
                .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .add(jPanel4Layout.createSequentialGroup()
                        .add(txtFechaReg, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 26, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        ...
        checkModelo.setFont(new java.awt.Font("Segoe UI Semilight", 0, 18)); // NOI18N
        ...
        checkCodigo.setFont(new java.awt.Font("Segoe UI Semilight", 0, 18)); // NOI18N
        ...
        checkSerie.setFont(new java.awt.Font("Segoe UI Semilight", 0, 18)); // NOI18N
        ...
        checkFabrica.setFont(new java.awt.Font("Segoe UI Semilight", 0, 18)); // NOI18N
        checkFabrica.setForeground(new java.awt.Color(204, 204, 204));
        checkFabrica.setText("Estado");
        ...
        checkMarca.setFont(new java.awt.Font("Segoe UI Semilight", 0, 18)); // NOI18N
        ...
        checkLote.setFont(new java.awt.Font("Segoe UI Semilight", 0, 18)); // NOI18N
        ...
        checkMedida.setFont(new java.awt.Font("Segoe UI Semilight", 0, 18)); // NOI18N
        checkMedida.setForeground(new java.awt.Color(204, 204, 204));
        checkMedida.setText("Cantidad");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .add(jPanel5Layout.createSequentialGroup()
                ...
                .add(jPanel5Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, txtfabrica, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        btnAgregar.setText("Generar Baja");
        ...
        btnAgregar1.setFont(new java.awt.Font("Segoe UI Semilight", 0, 18)); // NOI18N
        btnAgregar1.setForeground(new java.awt.Color(204, 204, 204));
        btnAgregar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icons8_New_Product_48px.png"))); // NOI18N
        ...
        btnAgregar1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        btnAgregar1.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
        btnAgregar1.setIconTextGap(10);
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel2Layout.createSequentialGroup()
                        ...
                        .add(14, 14, 14))
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel2Layout.createSequentialGroup()
                        .add(btnAgregar1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 183, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())))
        );
            ...
            .add(jPanel2Layout.createSequentialGroup()
                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    .add(jPanel2Layout.createSequentialGroup()
                        ...
                        .add(jButton4)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(btnAgregar1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 56, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        ...
        jLabel6.setText("Administración de Inventario Activos Fijos");
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .add(jPanel6Layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 181, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private boolean validarCampos() {
        if (txtIdProducto.getText().equals("") || txtFechaReg.getDate().equals("") || txtDescrip.getText().equals("") || comboCategoria.getSelectedIndex() == 0) {
    ...
    private void tablaProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaProductosMouseClicked
        ...
        p.setIdCategoria((Integer) tablaProductos.getValueAt(tablaProductos.getSelectedRow(), 3));
        ...
        p.setFabrica((String) tablaProductos.getValueAt(tablaProductos.getSelectedRow(), 7));

        txtIdProducto.setText(p.getIdProducto().toString());
        txtCodBarras.setText(p.getCodBarras().toString());
        txtDescrip.setText(p.getDescrip().toString());
        txtfabrica.setDate(p.getFechaFab());
        //txtFechaReg.setDate();
        txtLote.setText(p.getLote().toString());
        txtMarca.setText(p.getMarca().toString());
        txtModelo.setText(p.getModelo().toString());
        txtSerie.setText(p.getSerie().toString());
    ...
    private void btnMinimizedMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnMinimizedMouseClicked
        setExtendedState(ProductoInventarioFIjoView.ICONIFIED);
    ...
    private void btnRestoreMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRestoreMouseClicked
        setExtendedState(ProductoInventarioFIjoView.NORMAL);
    ...
    private void btnMaximizeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnMaximizeMouseClicked
        ...
        setExtendedState(ProductoInventarioFIjoView.MAXIMIZED_BOTH);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ProductoDTO p = gp.busquedaProductoID(Integer.parseInt(txtIdProducto.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductoInventarioFIjoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductoInventarioFIjoView().setVisible(true);
            }
        });
    }
